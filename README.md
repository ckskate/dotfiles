    ...
    sh -c "`curl -fsSL https://raw.github.com/sumukh/dotfiles/sumukh/install.sh`"
...
```bash
sh -c "`curl -fsSL https://raw.github.com/sumukh/dotfiles/master/install.sh`"
```
...
```bash
sh -c "`curl -fsSL https://raw.github.com/sumukh/dotfiles/master/install.sh`" -s ask
```
